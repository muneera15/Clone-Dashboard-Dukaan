...
return <table className="w-full ">
                ...
                <thead className=' bg-[#f2f2f2] grey-700'>
                    <tr>
                        ...
                        <th className='px-3 py-[10px] text-sm font-medium tracking-wider round-r text-center'>Order Amount</th>
                    </tr>
                </thead>
                <tbody className="bg-white">
                    <tr className='text-sm relative border-b-[1px]  border-[#e6e6e6]'>
                        ...
                        <td className="text-gray-700 text-[15px] px-3 py-[10px]">TRX123456</td>
