export const Header = () =>{
    ...
    <span className="flex items-center text-gray-700 gap-[6px]">
...
<div className="flex gap-2 justify-end sm:flex-grow">
    <span className="text-gray-700 bg-[#e6e6e6] rounded-full p-2 sm:w-10 sm:h-10 flex items-center justify-center cursor-pointer">
...
<span className="text-gray-700 bg-[#e6e6e6] rounded-full p-2 sm:h-10 sm:w-10 flex items-center justify-center cursor-pointer">
